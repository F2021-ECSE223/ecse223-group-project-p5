...
public class Guide extends SeasonalUser
{
  ...
  public Guide(String aUsername, String aPassword, ClimbSafe aClimbSafe, String aName, String aEmergencyContact, ClimbingSeason aSeason)
  {
    super(aUsername, aPassword, aClimbSafe, aName, aEmergencyContact);
    boolean didAddSeason = setSeason(aSeason);
    if (!didAddSeason)
    {
      throw new RuntimeException("Unable to create guide due to season. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  ...
  public boolean setSeason(ClimbingSeason aSeason)
  {
    ...
    {
      existingSeason.removeGuide(this);
    }
    season.addGuide(this);
    wasSet = true;
    return wasSet;
  }
  ...
  public void delete()
  {
    ...
    {
      placeholderSeason.removeGuide(this);
    }
