...
public class EquipmentsPageController {
	...
	@FXML
	private TableColumn<TOEquipment, Spinner<Integer>> delTableQuantity;
	@FXML
	...
	private void initEquipmentTable() {
	    ...
	    delTableQuantity.setCellValueFactory(new PropertyValueFactory<>("mpQuantity"));
	    /*
